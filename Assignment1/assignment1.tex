...
\end{lstlisting}
will be evaluated. In this portion, convert is called again with value of \textbf{n/2} and subsequently \textbf{n} goes from $n -> 0$. However as \textbf{n} = 0; the condition 
\begin{lstlisting}
    if(n<0) printf("%d", n);
\end{lstlisting}
